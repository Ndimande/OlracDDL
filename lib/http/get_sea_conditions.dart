...
Future<List<SeaCondition>> getSeaConditions() async {
  ...
  for (final Map seaConditionData in seaConditionList) {
    seaConditionType.add(SeaCondition(
        name: seaConditionData['displayname'],
        imageString: seaConditionData['code'],
        portugueseName: seaConditionData[
            'displayname_portuguese'])); //This need to be evaluated...Second Parameter!!!!!
  }
