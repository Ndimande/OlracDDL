...
class CompletedDisposalInfoScreen extends StatelessWidget {
      ...
      body: Column(
        children: [
          Breadcrumb(elements: [
            ...
            BreadcrumbElement(label: 'Disposal', onPressed: () {}),
          ...
          DataTable(
            ...
            rows: [
              ...
              dataRow(context, 'Disposal State', 'inesrt'),
              dataRow(context, 'Est. Green Weight', 'inesrt'),
